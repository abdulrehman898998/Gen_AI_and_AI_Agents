...
if uploaded_file:
    ...
    if features and target:
        ...
        if task == "Classification":
            model_type = st.selectbox("Select Classification Model", ["Random Forest", "Logistic Regression", "Decision Tree"])
            ...
            model_type = st.selectbox("Select Regression Model", ["Random Forest", "Linear Regression", "Decision Tree"])
            if model_type == "Random Forest":
                n_estimators = st.slider("Number of Trees", min_value=10, max_value=200, value=100, step=10)
